 ...
 * tuxun: ajouté a la fct execute() la lecture de newswidget.html
 *
 *
 *
 *
 ...
 * @ingroup Extensions
 */
class SpecialFunBlog extends IncludableSpecialPage {

	/**
	 * Constructor -- set up the new special page
	 */
	public function __construct() {
		parent::__construct( 'SpecialFunBlog' );
	}
	...
	public function execute( $limit ) {
		...
		//rajout du widget de news du blog
		$output.=file_get_contents (__DIR__ . '/widgets/newswidget.html');
