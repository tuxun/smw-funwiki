...
foreach ( $categories as $grisou ) {
						$grisou = trim( $grisou ); // GTFO@excess whitespace
						if ( !empty( $grisou ) ) {
							$wikitextCategories.= "$grisou\n";
						}
}
...
//MsUpload::start();
		...
		//$output .= EditPage::getEditToolbar();
//so this one bug
$output.='<div class="wikiEditor-oldToolbar" ></div><div id="toolbar"></div><div id="wikieditor-toolbar"></div>';
